...
# This method is capable of executing a code block. It use the Ruby yield method.
...
# to recieve the arguments and they must be placed within the pipe symbols
# |params, ....
...
# This method uses the call method that has been provided arguements.
...
# Code block are used throughout Ruby with iterators and collections such as array.
...
# Code blocks may be returned by functions, but irst they must be converted into
# Proc objects. Ruby has a function named lambda that convert a code block into 
# a Proc object.
def n_times thing
    lambda {|n| thing * n}
end
