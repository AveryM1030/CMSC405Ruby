...
# Notice the absence of parenthesis following the function name. Notice the absence
...
# Function is Ruby may have parameters.
def say_hello name
    return 'Hello ' + name + '!'
end
...
# Every function is an object. Every function is an object of the class it return.
